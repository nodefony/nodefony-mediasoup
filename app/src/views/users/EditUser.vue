...
<v-card v-if="currentUser || creating" tile class="mb-10 scroll" style="background:transparent">
  ...
  <v-toolbar extended prominent color="#1a242d" dark>
          ...
          <v-banner v-if='hasRoleAdmin || isMe' two-line>
            <form autocomplete="on">
              ...
              <v-row>
                ...
                <v-col cols="9">
                  <v-text-field v-model="oldPassword" autocomplete="new-password" :append-icon="show2 ? 'mdi-eye' : 'mdi-eye-off'" :rules="[rules.required, rules.min]" :type="show2 ? 'text' : 'password'" name="oldpassword" label="Old Password" hint="At least 8 characters"
